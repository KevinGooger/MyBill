...
public class DBOpenHelper extends SQLiteOpenHelper {
    public DBOpenHelper(@Nullable Context context) {
        super(context,"mybill.db" , null, 1);
    }
...
//      向typetb表当中插入元素
        ...
        db.execSQL(sql,new Object[]{"奶茶饮品", R.mipmap.ic_yanjiu,R.mipmap.ic_yanjiu_fs,0});
        ...
        db.execSQL(sql,new Object[]{"日常交际", R.mipmap.ic_renqingwanglai,R.mipmap.ic_renqingwanglai_fs,0});
